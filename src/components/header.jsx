...
const Header = ({
  ...
  return (
    <Navbar expand="lg" className="bg-white font-weight-bold navbar-custom sticky-top" style={{paddingTop:'10px',paddingBottom:'10px' , paddingLeft: '100px', paddingRight: '100px' }}>
      <Container fluid>
        <Navbar.Brand href="#" className="d-flex align-items-center">
          <img src={require('../Image/logo.png')} alt="Brand Logo" width="45px" height="auto" />
          <Navbar.Brand className="m-lg-2" href="#">DARSHAN NETWORKS</Navbar.Brand>
        </Navbar.Brand>
